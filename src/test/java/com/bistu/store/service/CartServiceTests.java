...
//        cartService.addToCart(15,10000005,5,"admin");
        cartService.addToCart(15,10000022,5,"admin");
    }

    @Test
    public void getVOByUid(){
        System.out.println(cartService.getVOByUid(15));
    }

    @Test
    public void delCartItem(){
        cartService.delCartItem(9);
    }

    @Test
    public void findByCid(){
        System.out.println(cartService.addNum(1,15,"admin"));
    }
}
